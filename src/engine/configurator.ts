...
export const VERSION_TAG = 'IB-TERR-VERSION-019.4';
...
export function runConfigurator(input: ProjectInput): ConfiguratorResult {
  ...
  const trace: string[] = [`[${VERSION_TAG}] V0.19.4 : visserie d’habillage latéral intégrée, longueurs et SKU catalogue vérifiés, garde-fou d’exactitude structurelle, calepinage CALPI, plan/photo calibré, PDF technique et 3D enrichie.`];
