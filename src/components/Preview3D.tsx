    ...
    <div className="visual-card professional-3d">
      ...
      <div className="preview3d-toolbar">
        <div className="segmented small-segmented">
          <button type="button" className={clientRender ? 'active' : ''} onClick={() => setClientRender(true)}>Rendu client</button>
          <button type="button" className={!clientRender ? 'active' : ''} onClick={() => setClientRender(false)}>Vue technique</button>
        </div>
