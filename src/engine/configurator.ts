...
export const VERSION_TAG = 'IB-TERR-VERSION-019.5';
...
export function runConfigurator(input: ProjectInput): ConfiguratorResult {
  ...
  const trace: string[] = [`[${VERSION_TAG}] V0.19.5 : supports verticaux d’habillage alignés sur la structure validée, visserie intégrée et longueurs/SKU vérifiés, calepinage CALPI, plan/photo calibré, PDF technique et 3D enrichie.`];
